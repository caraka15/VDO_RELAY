<script lang="ts">
  ...
  $: pageDescription = publisherStatus === "ready" || publisherStatus === "error" ? "Tekan Start untuk membuka kamera dan mengirim frame native ke relay." : "Preview mengikuti kamera langsung. Orientasi, resolusi, dan FPS tetap terkunci.";
