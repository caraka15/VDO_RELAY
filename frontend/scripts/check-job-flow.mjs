...
assert.match(publisher, /stun:stun\.l\.google\.com:19302/, "WHIP publisher must have a normal ICE fallback");
...
assert.match(publisher, /waitForIceGathering/, "WHIP publisher must wait for initial ICE gathering");
...
assert.match(publisher, /video\/rtx/, "WHIP publisher must preserve RTX recovery codecs");
assert.match(publisher, /video\/ulpfec/, "WHIP publisher must preserve FEC recovery codecs");
...
assert.match(publisher, /async getStats\(\)/, "WHIP publisher must expose sender diagnostics");
assert.match(publisher, /qualityLimitationReason/, "WHIP diagnostics must expose browser quality limits");
